        ...
        <table width="96%" bgcolor="#CEF6EC" border="1" BORDERCOLOR=white style="border-collapse: collapse;" style="border: 1px solid black;">
			...
			<li>
				<div style="float: left;">
					<a href="index3-36.jsp"><img src="img/pic42.jpg" alt="花火" id="itemImg" width="180" height="230"></a>
				</div>
				<div style="float: left;">
					<H2 style="color:BLUE;">花火(Hanabi)</H2>
					<p style="color:BLACK;">人數：2~5人</p>
					<p style="color:BLACK;">作者：Antoine Bauza</p>
					<p style="color:BLACK;">類別：派對遊戲</p>
					<p style="color:BLACK;">Price: 399 NTD</p>
					<p><a href="index3-36.jsp" style="color:blue;">MORE</a></p>
				</div>
			...
			<td width="32%"><li>
				<div style="float: left;">
					<a href="index3-37.jsp"><img src="img/pic43.jpg" alt="地產大亨(Deal)" id="itemImg" width="180" height="230"></a>
				</div>
				<div style="float: left;">
					<H2 style="color:BLUE;">地產大亨(Deal)</H2>
					<p style="color:BLACK;">人數：2~5人</p>
					<p style="color:BLACK;">作者：Hasbro</p>
					<p style="color:BLACK;">類別：派對遊戲</p>
					<p style="color:BLACK;">Price: 249 NTD</p>
					<p><a href="index3-37.jsp" style="color:blue;">MORE</a></p>
				</div>
				<div style="float: none; clear: both;"></div>				
</li></td>
<td width="32%"><li>
    <div style="float: left;">
        <a href="index3-38.jsp"><img src="img/pic44.jpg" alt="UNO" id="itemImg" width="180" height="230"></a>
    </div>
    <div style="float: left;">
        <H2 style="color:BLUE;">UNO</H2>
        <p style="color:BLACK;">人數：2~10人</p>
        <p style="color:BLACK;">作者：no</p>
		<p style="color:BLACK;">類別：家庭遊戲</p>
					<p style="color:BLACK;">Price: 199 NTD</p>
        <p><a href="index3-38.jsp" style="color:blue;">MORE</a></p>
    </div>
    <div style="float: none; clear: both;"></div>
...
<table width="96%" bgcolor="WHITE" border="1" BORDERCOLOR=#00b36b style="border-collapse: collapse;" style="border: 1px solid black;">
			...
			<li>
				<div style="float: left;">
					<a href="index3-3.jsp"><img src="pic4.jpg" alt="卡卡頌(Carcassonne)" id="itemImg" width="180" height="230"></a>
				</div>
				<div style="float: left;">
					...
					<p style="color:BLACK;">類別：派對遊戲</p>
					<p style="color:BLACK;">Price: 1100 NTD</p>
			...
			<td width="32%"><li>
				<div style="float: left;">
					<a href="index3-4.jsp"><img src="pic12.jpg" alt="知識線環球旅行篇" id="itemImg" width="180" height="230"></a>
				</div>
								<div style="float: left;">
...
<td width="32%"><li>
    <div style="float: left;">
        <a href="index3-5.jsp"><img src="pic14.jpg" alt="驢橋" id="itemImg" width="180" height="230"></a>
    </div>
    				<div style="float: left;">
...
<table width="96%" bgcolor="#CEF6EC" border="1" BORDERCOLOR=white style="border-collapse: collapse;" style="border: 1px solid black;">
			...
			<li>
				<div style="float: left;">
					<a href="index3-6.jsp"><img src="pic15.jpg" alt="妙語說書人" id="itemImg" width="180" height="230"></a>
				</div>
								<div style="float: left;">
			...
			<td width="32%"><li>
				<div style="float: left;">
					<a href="index3-7.jsp"><img src="pic11.jpg" alt="矮人礦坑" id="itemImg" width="180" height="230"></a>
				</div>
								<div style="float: left;">
