        ...
        <table width="96%" bgcolor="#CEF6EC" border="1" BORDERCOLOR=white style="border-collapse: collapse;" style="border: 1px solid black;">
			...
			<li>
				<div style="float: left;">
					<a href="index3-18.jsp"><img src="img/pic24.jpg" alt="狼來了(Woookf)" id="itemImg" width="180" height="230"></a>
				</div>
				<div style="float: left;">
					<H2 style="color:BLUE;">狼來了(Woookf)</H2>
					<p style="color:BLACK;">人數：4~8人</p>
					<p style="color:BLACK;">作者：Bono Light</p>
					<p style="color:BLACK;">類別：派對遊戲</p>
					<p style="color:BLACK;">Price: 800 NTD</p>
					<p><a href="index3-18.jsp" style="color:blue;">MORE</a></p>
				</div>
			...
			<td width="32%"><li>
				<div style="float: left;">
					<a href="index3-19.jsp"><img src="img/pic25.jpg" alt="狼人(Werewovle)" id="itemImg" width="180" height="230"></a>
				</div>
				<div style="float: left;">
					<H2 style="color:BLUE;">狼人(Werewovle)</H2>
					<p style="color:BLACK;">人數：8~18人</p>
					<p style="color:BLACK;">作者：Hervé Marly</p>
					<p style="color:BLACK;">類別：派對遊戲</p>
					<p style="color:BLACK;">Price: 490 NTD</p>
					<p><a href="index3-19.jsp" style="color:blue;">MORE</a></p>
				</div>
				<div style="float: none; clear: both;"></div>				
</li></td>
<td width="32%"><li>
    <div style="float: left;">
        <a href="index3-20.jsp"><img src="img/pic26.jpg" alt="詐賭巫師" id="itemImg" width="180" height="230"></a>
    </div>
    <div style="float: left;">
        <H2 style="color:BLUE;">詐賭巫師</H2>
        <p style="color:BLACK;">人數：3~6人</p>
        <p style="color:BLACK;">作者：Stefan Dorra</p>
		<p style="color:BLACK;">類別：派對遊戲</p>
					<p style="color:BLACK;">Price: 550 NTD</p>
        <p><a href="index3-20.jsp" style="color:blue;">MORE</a></p>
    </div>
    <div style="float: none; clear: both;"></div>
...
<table width="96%" bgcolor="WHITE" border="1" BORDERCOLOR=#00b36b style="border-collapse: collapse;" style="border: 1px solid black;">
			...
			<li>
				<div style="float: left;">
					<a href="index3-21.jsp"><img src="img/pic27.jpg" alt="推倒提基(Tikitoople)" id="itemImg" width="180" height="230"></a>
				</div>
				<div style="float: left;">
					<H2 style="color:BLUE;">推倒提基(Tikitoople)</H2>
					<p style="color:BLACK;">人數：2~4人</p>
					<p style="color:BLACK;">作者：Keith Meyers</p>
					<p style="color:BLACK;">類別：家庭遊戲</p>
					<p style="color:BLACK;">Price: 729 NTD</p>
					<p><a href="index3-21.jsp" style="color:blue;">MORE</a></p>
				</div>
				<div style="float: none; clear: both;"></div>
			...
			<td width="32%"><li>
				<div style="float: left;">
					<a href="index3-22.jsp"><img src="img/pic28.jpg" alt="是誰放的屁" id="itemImg" width="180" height="230"></a>
				</div>
								<div style="float: left;">
					<H2 style="color:BLUE;">是誰放的屁</H2>
					<p style="color:BLACK;">人數：2~5人</p>
					<p style="color:BLACK;">作者：Bruno Cathala</p>
					<p style="color:BLACK;">類別：派對遊戲</p>
					<p style="color:BLACK;">Price: 449 NTD</p>
					<p><a href="index3-22.jsp" style="color:blue;">MORE</a></p>
				</div>
				<div style="float: none; clear: both;"></div>
...
<td width="32%"><li>
    <div style="float: left;">
        <a href="index3-23.jsp"><img src="img/pic29.jpg" alt="進擊地下城" id="itemImg" width="180" height="230"></a>
    </div>
    				<div style="float: left;">
					<H2 style="color:BLUE;">進擊地下城</H2>
					<p style="color:BLACK;">人數：3~5人</p>
					<p style="color:BLACK;">作者：Thies Schwarz</p>
					<p style="color:BLACK;">類別：家庭遊戲</p>
					<p style="color:BLACK;">Price: 799 NTD</p>
					<p><a href="index3-23.jsp" style="color:blue;">MORE</a></p>
				</div>
				<div style="float: none; clear: both;"></div>
...
<table width="96%" bgcolor="#CEF6EC" border="1" BORDERCOLOR=white style="border-collapse: collapse;" style="border: 1px solid black;">
			...
			<li>
				<div style="float: left;">
					<a href="index3-24.jsp"><img src="img/pic30.jpg" alt="不要命的冒險" id="itemImg" width="180" height="230"></a>
				</div>
								<div style="float: left;">
					<H2 style="color:BLUE;">不要命的冒險</H2>
					<p style="color:BLACK;">人數：2~6人</p>
					<p style="color:BLACK;">作者：Ludovic Chapellière</p>
					<p style="color:BLACK;">類別：家庭遊戲</p>
					<p style="color:BLACK;">Price: 390 NTD</p>
					<p><a href="index3-24.jsp" style="color:blue;">MORE</a></p>
				</div>
				<div style="float: none; clear: both;"></div>
			...
			<td width="32%"><li>
				<div style="float: left;">
					<a href="index3-25.jsp"><img src="img/pic31.jpg" alt="人體模型" id="itemImg" width="180" height="230"></a>
				</div>
								<div style="float: left;">
					<H2 style="color:BLUE;">人體模型</H2>
					<p style="color:BLACK;">人數：2~4人</p>
					<p style="color:BLACK;">作者：no</p>
					<p style="color:BLACK;">類別：派對遊戲</p>
					<p style="color:BLACK;">Price: 500 NTD</p>
					<p><a href="index3-25.jsp" style="color:blue;">MORE</a></p>
				</div>
				<div style="float: none; clear: both;"></div>
...
<td width="32%"><li>
    <div style="float: left;">
        <a href="index3-26.jsp"><img src="img/pic32.jpg" alt="失落的城市(Lost city)" id="itemImg" width="180" height="230"></a>
    </div>
    				<div style="float: left;">
					<H2 style="color:BLUE;">失落的城市(Lost city)</H2>
					<p style="color:BLACK;">人數：2人</p>
					<p style="color:BLACK;">作者：R.K</p>
					<p style="color:BLACK;">類別：派對遊戲</p>
					<p style="color:BLACK;">Price: 780 NTD</p>
					<p><a href="index3-26.jsp" style="color:blue;">MORE</a></p>
				</div>
				<div style="float: none; clear: both;"></div>
