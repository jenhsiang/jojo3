...
<body>
	  ...
	  <center>
		...
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="img/pic30.jpg" style="width:300px;height:400px;" align="left">
			 ...
			 *遊戲開始<br>
			 這是一場艱難的冒險！
			不要命的冒險<br>
			在費倫王國中，一頭兇狠的巨龍威脅著所有居民的安全！
			所以國王頒布了優沃的懸賞，給能夠獵殺這頭野獸的勇士。<br>
			所有的賞金獵人都急著找尋巨龍，因為只有第一個帶回巨龍屍體的人才是贏家。
			「不要命的冒險」是一場要穿越原野、陷害其他冒險者、擊殺怪物、運用祕技還要征服一頭巨龍的紙牌遊戲。<br>
			</font>
			</p>
			</th>
		...
		<div class="fb-comments" data-href="http://www.top-martin.net/index3-24.jsp" data-colorscheme="light" data-numposts="100" data-width="700"></div>
