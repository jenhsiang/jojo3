...
<body>
	  ...
	  <center>
		...
		<h2 style="color:#FA5858" align="center" ><font face="Algerian">媽媽咪呀(Mammamia)</font></h2>
		
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="img/pic39.jpg" style="width:300px;height:400px;" align="left">
			...
			<font color="#5F4C0B">
			 ...
			 <font color="#0B615E">
			 *遊戲開始<br>
			 「媽媽咪呀(Mamma Mia！)」遊戲為1999年由Uwe Rosenberg所設計的家庭遊戲，並獲得1999年德國年度遊戲獎項推薦。
			 遊戲中玩家們皆為主廚(Mamma Mia！)的助手，晚餐時刻湧進大批訂單，助手們須使出渾身解數，想盡辦法完成訂單，成為主廚心中最得意的助手。
			 每位玩家在遊戲過程中均被要求完成8種不同類型的披薩訂單，若已打出的材料符合訂單內容，則打出這張訂單的玩家即可得分。遊戲進行三個回合，由完成最多訂單的玩家取得勝利。<br>
			</font>
			</p>
			</th>
		...
		<div class="fb-comments" data-href="http://www.top-martin.net/index3-33.jsp" data-colorscheme="light" data-numposts="100" data-width="700"></div>
