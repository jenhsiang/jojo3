...
<body>
	  ...
	  <center>
		...
		<h2 style="color:#FA5858" align="center" ><font face="Algerian">狼人(Werewovle)</font></h2>
		
		
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="img/pic25.jpg" style="width:300px;height:400px;" align="left">
			 ...
			 *遊戲開始<br>
			  其實狼人就是大家很熟悉的殺手遊戲
				事實上，狼人也是建立在殺手的機制，並且加入一些新的構想來設計
				所以這遊戲用幾張撲克牌就可以玩了，需不需要特別買這款遊戲就見仁見智<br>
			</font>
			</p>
			</th>
		...
		<div class="fb-comments" data-href="http://www.top-martin.net/index3-19.jsp" data-colorscheme="light" data-numposts="100" data-width="700"></div>
