...
<body>
	  ...
	  <center>
		...
		<h2 style="color:#FA5858" align="center" ><font face="Algerian">妙廚上菜</font></h2>
		
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="img/pic40.jpg" style="width:300px;height:400px;" align="left">
			...
			<font color="#5F4C0B">
			 ...
			 <font color="#0B615E">
			 *遊戲開始<br>
			「妙廚上菜(A la carte)」遊戲為1989年由Karl-Heinz Schmiel所設計的家庭遊戲，並獲得1990年德國遊戲獎最佳家庭／成人遊戲獎項第二名。
			遊戲中玩家們扮演著法國餐廳大廚，須努力的完成客人所指定的菜餚，若能將料理精確的製作完成，將獲得一顆星的獎勵。遊戲過程中，玩家們進行烹調競賽，
			除須對自家料理的火侯控制及調味比重拿捏精準外，
			尚可透過咖啡杯之特殊功能來擾亂對手。遊戲進行至當有玩家榮登3星主廚及完成5道菜餚時即告結束，該玩家亦成為遊戲贏家。<br>
			</font>
			</p>
			</th>
		...
		<div class="fb-comments" data-href="http://www.top-martin.net/index3-34.jsp" data-colorscheme="light" data-numposts="100" data-width="700"></div>
