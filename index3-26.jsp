...
<body>
	  ...
	  <center>
		...
		<h2 style="color:#FA5858" align="center" ><font face="Algerian">失落的城市(Lost city)</font></h2>
		
		
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="img/pic32.jpg" style="width:300px;height:400px;" align="left">
			...
			<font color="#5F4C0B">
			 ...
			 <font color="#0B615E">
			 *遊戲開始<br>
			 這是遊戲設計大師R.K設計的一款小品，目前擠進BGG前百大
			如果除去卡片圖樣不看，這是一款傳統維律，也就是像下棋的遊戲
			但多了華麗的美術風格與主題包裝後，讓這款遊戲變得饒富趣味
			另外簡單的規則也替失落城市加分<br>
			</font>
			</p>
			</th>
		...
		<div class="fb-comments" data-href="http://www.top-martin.net/index3-26.jsp" data-colorscheme="light" data-numposts="100" data-width="700"></div>
