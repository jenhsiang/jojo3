...
<body>
	  ...
	  <center>
		...
		<h2 style="color:#FA5858" align="center" ><font face="Algerian">人體模型</font></h2>
		
		
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="img/pic31.jpg" style="width:300px;height:400px;" align="left">
			...
			<font color="#5F4C0B">
			 ...
			 <font color="#0B615E">
			 *遊戲開始<br>
			 說到「桌上遊戲」，大家直覺應該都會想到以圖板或紙牌建構為主的德系或美系遊戲，不過除了玩法偏策略性與主題正經八百的桌遊，
			 其實也有不少適合在多人聚會或是派對歡樂場合遊玩的桌遊。如果想要嚐試簡單好上手、又沒什麼複雜規則，同時玩起來又刺激有氣氛的桌遊，
			 那就一定得推薦一下這款由日本玩家商「MegaHouse」所推出的這款「跳動崩解人體模型（ドキドキクラッシュ人体模型）」！<br>
			</font>
			</p>
			</th>
		...
		<div class="fb-comments" data-href="http://www.top-martin.net/index3-25.jsp" data-colorscheme="light" data-numposts="100" data-width="700"></div>
