        ...
        <table width="96%" bgcolor="#CEF6EC" border="1" BORDERCOLOR=white style="border-collapse: collapse;" style="border: 1px solid black;">
			...
			<li>
				<div style="float: left;">
					<a href="index3-9.jsp"><img src="img/pic15.jpg" alt="盜夢都市" id="itemImg" width="180" height="230"></a>
				</div>
				<div style="float: left;">
			...
			<td width="32%"><li>
				<div style="float: left;">
					<a href="index3-10.jsp"><img src="img/pic16.jpg" alt="泥巴大戰" id="itemImg" width="180" height="230"></a>
				</div>
				<div style="float: left;">
...
<td width="32%"><li>
    <div style="float: left;">
        <a href="index3-11.jsp"><img src="img/pic17.jpg" alt="七吃九" id="itemImg" width="180" height="230"></a>
    </div>
    <div style="float: left;">
...
<table width="96%" bgcolor="WHITE" border="1" BORDERCOLOR=#00b36b style="border-collapse: collapse;" style="border: 1px solid black;">
			...
			<li>
				<div style="float: left;">
					<a href="index3-12.jsp"><img src="img/pic18.jpg" alt="諾亞方舟(NoahARK)" id="itemImg" width="180" height="230"></a>
				</div>
				<div style="float: left;">
			...
			<td width="32%"><li>
				<div style="float: left;">
					<a href="index3-13.jsp"><img src="img/pic19.jpg" alt="牛頭王(Take6)" id="itemImg" width="180" height="230"></a>
				</div>
								<div style="float: left;">
...
<td width="32%"><li>
    <div style="float: left;">
        <a href="index3-14.jsp"><img src="img/pic20.jpg" alt="空中之城(Celestia)" id="itemImg" width="180" height="230"></a>
    </div>
    				<div style="float: left;">
...
<table width="96%" bgcolor="#CEF6EC" border="1" BORDERCOLOR=white style="border-collapse: collapse;" style="border: 1px solid black;">
			...
			<li>
				<div style="float: left;">
					<a href="index3-15.jsp"><img src="img/pic21.jpg" alt="殭屍商場(MallofHorror)" id="itemImg" width="180" height="230"></a>
				</div>
								<div style="float: left;">
			...
			<td width="32%"><li>
				<div style="float: left;">
					<a href="index3-16.jsp"><img src="img/pic22.jpg" alt="糟了個糕" id="itemImg" width="180" height="230"></a>
				</div>
								<div style="float: left;">
...
<td width="32%"><li>
    <div style="float: left;">
        <a href="index3-17.jsp"><img src="img/pic23.jpg" alt="馬尼拉" id="itemImg" width="180" height="230"></a>
    </div>
    				<div style="float: left;">
