...
<body>
	  ...
	  <center>
		...
		<h2 style="color:#FA5858" align="center" ><font face="Algerian">推倒提基(Tikitoople)</font></h2>
		
		
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="img/pic27.jpg" style="width:300px;height:400px;" align="left">
			...
			<font color="#5F4C0B">
			 ...
			 <font color="#0B615E">
			 *遊戲開始<br>
			  ▲提基(Tiki)在玻里尼西亞的一些文化中，是象徵神聖且超自然的雕像，提基(Tiki)是用木頭及石頭雕刻且以鮮豔及超大型的臉為特徵。<br>
			  ■遊戲中歡迎玩家來到提基島，該處為九座鮮豔雕像之故鄉，玩家要讓自已任務的雕像競逐成為玻里尼西亞人心中最棒的偶像！<br>
			  ■一款規則簡單又頗有心機的遊戲，要怎麼不輕易讓別人太早看出自已的任務提基顏色是需要技巧的哦，否則太早被識破你的秘密任務提基，只有被推倒及燒毁的下場啊～<br>
			</font>
			</p>
			</th>
		...
		<div class="fb-comments" data-href="http://www.top-martin.net/index3-21.jsp" data-colorscheme="light" data-numposts="100" data-width="700"></div>
