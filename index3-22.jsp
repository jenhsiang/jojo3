...
<body>
	  ...
	  <center>
		...
		<h2 style="color:#FA5858" align="center" ><font face="Algerian">是誰放的屁</font></h2>
		
		
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="img/pic28.jpg" style="width:300px;height:400px;" align="left">
			...
			<font color="#5F4C0B">
			 ...
			 <font color="#0B615E">
			 *遊戲開始<br>
			  1. 承認罪行，向眾人坦承這次是你放屁，然後拿走場上所有的羞恥卡<br>
			  2. 矢口否認，此時問話玩家從他手中抽出一張氣味卡，攤開放在他面前，這將提供其他人一些參考資訊<br>
			</font>
			</p>
			</th>
		...
		<div class="fb-comments" data-href="http://www.top-martin.net/index3-22.jsp" data-colorscheme="light" data-numposts="100" data-width="700"></div>
