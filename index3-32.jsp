...
<body>
	  ...
	  <center>
		...
		<h2 style="color:#FA5858" align="center" ><font face="Algerian">德國蟑螂</font></h2>
		
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="img/pic38.jpg" style="width:300px;height:400px;" align="left">
			...
			<font color="#5F4C0B">
			 ...
			 <font color="#0B615E">
			 *遊戲開始<br>
			 德國蟑螂是相當簡單的紙牌遊戲，玩法有點類似Knock!Knock!，
			都是把手上的牌面朝下推到別人面前然後喊出一個名字，讓對方猜自己有沒有說謊。
			相較之下德國蟑螂規則比較簡單，而且能夠支援較多人，算是既有趣又心機的小品遊戲。<br>
			</font>
			</p>
			</th>
		...
		<div class="fb-comments" data-href="http://www.top-martin.net/index3-32.jsp" data-colorscheme="light" data-numposts="100" data-width="700"></div>
