...
<body>
	  ...
	  <center>
		...
		<h2 style="color:#FA5858" align="center" ><font face="Algerian">阿瓦隆</font></h2>
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="img/pic13.jpg" style="width:300px;height:400px;" align="left">
			...
			<font color="#5F4C0B">
			 ...
			 <font color="#0B615E">
			 *遊戲開始<br>
			 遊戲主要講述梅林法師和圓桌武士們為亞瑟王找尋聖杯的故事，然而在路途中，團隊卻混入了邪惡法師的爪牙，
			 想要暗中破壞，干擾任務的進行。玩家們就是要扮演這些角色，但除了部分有特殊能力的角色之外，大部分的圓桌武士只知道自己的身分，
			 因此如何在出任務的過程中，逐步觀察其他玩家的選擇和話語，找到自己的同伴，是這款遊戲致勝的關鍵。<br>
			</font>
			</p>
			</th>
		...
		<tr>
			<th style="width:25%" >
					<iframe width="70%" height="600" src="https://www.youtube.com/embed/AdHejKQFmzY" frameborder="0" allowfullscreen></iframe>
					<p>
		...
		<div class="fb-comments" data-href="http://www.top-martin.net/index3-39.jsp" data-colorscheme="light" data-numposts="100" data-width="700"></div>
