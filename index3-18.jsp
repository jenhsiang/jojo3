...
<body>
	  ...
	  <center>
		...
		<h2 style="color:#FA5858" align="center" ><font face="Algerian">狼來了(Woookf)</font></h2>
		
		
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="img/pic24.jpg" style="width:300px;height:400px;" align="left">
			...
			<font color="#5F4C0B">
			 ...
			 <font color="#0B615E">
			 *遊戲開始<br>
			  「狼來了(Wooolf！！)」遊戲為2013年由臺灣桌遊設計師陳柏光所自製的派對遊戲，遊戲過程鬥智趣味。
			  遊戲中玩家們扮演著大野狼、綿羊、獵人、獵犬及牧羊小孩等角色，須小心翼翼的找出彼此的真實身分，才能贏得遊戲勝利。
			  遊戲進行時，每位玩家各有2張角色卡，但僅有1張為真實身分，另1張則作為混淆身分之用。遊戲過程中，玩家們須透過察看角色卡及使用問題卡來尋找角色，並透過進行宣告以指認身分。
			  遊戲持續進行至當有玩家獲得2個錯誤標記或進行3個回合後即告結束，並由分數最高者成為遊戲贏家。<br>
			</font>
			</p>
			</th>
		...
		<div class="fb-comments" data-href="http://www.top-martin.net/index3-18.jsp" data-colorscheme="light" data-numposts="100" data-width="700"></div>
