...
遊戲當中若有人出局，出局的玩家將他手上的牌攤開放在自己面前(不需執行此張牌的效果)，表示今天他已經沒有機會將情書送到公主面前啦!<br>
	...
	<h2 style="color:blue" align="center" style="font-family:Microsoft JhengHei;">教學影片</h2>
		...
		<tr>
			<th style="width:25%" >
					<iframe width="70%" height="600" src="https://www.youtube.com/embed/D66v_HmNr6g" frameborder="0" allowfullscreen></iframe>
					<p>
		...
		<div class="fb-comments" data-href="http://www.top-martin.net/index3-6.jsp" data-colorscheme="light" data-numposts="100" data-width="700"></div>
