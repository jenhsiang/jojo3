...
<body>
	  ...
	  <center>
		...
		<h2 style="color:#FA5858" align="center" ><font face="Algerian">詐賭巫師</font></h2>
		
		
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="img/pic26.jpg" style="width:300px;height:400px;" align="left">
			...
			<font color="#5F4C0B">
			 ...
			 <font color="#0B615E">
			 *遊戲開始<br>
			  ▲在怪物競技賭場裡，只要押注的鬥士獲勝，就能得到一大筆賞金。 <br>
			  ■秘密地使用咒語，想盡辦法獲得獲得勝利。 <br>
			  ■每場比賽的裁判個性都不同，誰能口袋滿滿地回家？<br>
			</font>
			</p>
			</th>
		...
		<div class="fb-comments" data-href="http://www.top-martin.net/index3-20.jsp" data-colorscheme="light" data-numposts="100" data-width="700"></div>
