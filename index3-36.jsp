...
<body>
	  ...
	  <center>
		...
		<h2 style="color:#FA5858" align="center" ><font face="Algerian">花火(Hanabi)</font></h2>
		
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="img/pic42.jpg" style="width:300px;height:400px;" align="left">
			...
			<font color="#5F4C0B">
			 ...
			 <font color="#0B615E">
			 *遊戲開始<br>
			 花火是款與一般遊戲都不同的互助合作遊戲，中文版今年在台灣上市，每年跨年台北的101煙火是大家都非常期待的一場饗宴，
			 現在就請各位扮演施放101煙火的師傅一起努力將最璀璨的煙火施放出來，重點是如何透過伙伴的提示一點一滴地將煙火正確地排放，一起來同心協力達成目標吧!<br>
			</font>
			</p>
			</th>
		...
		<div class="fb-comments" data-href="http://www.top-martin.net/index3-36.jsp" data-colorscheme="light" data-numposts="100" data-width="700"></div>
