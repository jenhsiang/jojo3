...
<body>
	  ...
	  <center>
		...
		<h2 style="color:#FA5858" align="center" ><font face="Algerian">終極密碼</font></h2>
		
		
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="img/pic35.jpg" style="width:300px;height:400px;" align="left">
			...
			<font color="#5F4C0B">
			 ...
			 <font color="#0B615E">
			 *遊戲開始<br>
			 「隱藏自己的代碼，猜測對手的代碼；推敲可能的解答，並讓這些敵人完全露出驚訝。」
				在終極密碼戰當中，唯一要獲勝的方法便是全神貫注，不放過任何無意間透露而出的訊息！
				玩家們將會得到一組密碼，這段密碼的數字將會越來越長，不過提示也跟著相對增加。
				排除不可能的答案，將其他玩家持有的密碼通通揭露，你就是勝利的贏家！<br>
			</font>
			</p>
			</th>
		...
		<tr>
			<th style="width:25%" >
					<iframe width="70%" height="600" src="https://www.youtube.com/embed/N0XEjcUJJF0" frameborder="0" allowfullscreen></iframe>
					<p>
		...
		<div class="fb-comments" data-href="http://www.top-martin.net/index3-29.jsp" data-colorscheme="light" data-numposts="100" data-width="700"></div>
