...
<body>
	  ...
	  <center>
		...
		<h2 style="color:#FA5858" align="center" ><font face="Algerian">富饒之城(Citadels)</font></h2>
		
		
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="img/pic36.jpg" style="width:300px;height:400px;" align="left">
			...
			<font color="#5F4C0B">
			 ...
			 <font color="#0B615E">
			 *遊戲開始<br>
			 富饒之城是個相當有名的遊戲，堪稱心機類遊戲的代表作，全球的銷售不說，在台灣賣的也是嚇嚇叫。
				正因為賣的很好，所以富饒之城也有出中文版，而且有附上擴充 (暗黑城市The Dark City) 。
				這遊戲還是有吃一點英文，因此最好還是多多支持中文，而且對新手來說有中文感覺也比較親切。

				玩家在遊戲中扮演著中世紀的城堡領主，運用各種不同的人物來幫助你建設或妨礙他人。
				雖然遊戲規則對新手來說稍嫌困難了點，但是通常跑過一輪就能感受到這遊戲的心機魅力所在。<br>
			</font>
			</p>
			</th>
		...
		<div class="fb-comments" data-href="http://www.top-martin.net/index3-30.jsp" data-colorscheme="light" data-numposts="100" data-width="700"></div>
