...
<body>
	  ...
	  <center>
		...
		<h2 style="color:#FA5858" align="center" ><font face="Algerian">UNO</font></h2>
		
		<table border="0" width="80%" height="350">
			<th width="20%"><img src="img/pic44.jpg" style="width:300px;height:400px;" align="left">
			...
			<font color="#5F4C0B">
			 ...
			 <font color="#0B615E">
			 *遊戲開始<br>
			 想必大家對UNO並不陌生，這是少數可以在玩具反斗城買到的紙牌遊戲，
				更不用提他的幾個系列作都曾在電視螢幕上露臉過。
				雖然對桌遊玩家來說看到不會玩UNO的人就好像是在大街上看到苔原雪怪一樣，
				但實際上真的有很多人對這個遊戲相當陌生，甚至連聽都沒聽過。<br>
				遊戲的配件為108張紙牌──76張數字牌、8張阻擋牌、8張反轉牌、8張罰抽二張牌、
				4張萬用牌以及4張王牌。<br>
			</font>
			</p>
			</th>
		...
		<div class="fb-comments" data-href="http://www.top-martin.net/index3-38.jsp" data-colorscheme="light" data-numposts="100" data-width="700"></div>
